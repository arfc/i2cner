...
\begin{figure}[H] 
\centering
\includegraphics[scale=1.2]{cost}
...
\begin{block}{Limitations and Future work}
    ...
    \item Annual timesteps and annually averaged capacity factors limit ability to capture seasonal and daily variation in wind and solar.    
    
    \item Capture realistic, gradual transition behaviour and fluctuations in demand due to population decline in Japan.
