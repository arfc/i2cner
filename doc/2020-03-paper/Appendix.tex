...
Photovoltaic & 332 \\
Onshore wind & 180 \\
Offshore wind (fixed) & 130 \\
Offshore wind (floating) & 260 \\
Nuclear & 50 (Scenarios 3 \& 4) \\
 & 100 (Scenario 2) \\
\gls{PWS} & 100 (Scenario 5) \\
\hline 
\end{tabularx}
\label{caplim}
\end{table}
...
Li-ion discharge time & 4h \\
Li-ion E/P ratio & 4 \\
Li-ion depth-of-discharge & 80\% \\
Li-ion lifetime cycles & 3500  \\
\hline 
	\end{tabularx}
\label{misc-assump}
\end{table}