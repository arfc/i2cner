    ...
    \makebox[\linewidth]{%
      \makebox[0pt][l]{%
        \raisebox{\dimexpr-\height+\baselineskip}[0pt][0pt]
          {\includegraphics[height=3\baselineskip]{i2cner_logo}}% Left logo
      }\hfill
      \makebox[0pt]{I$^2$CNER-Enabled Transitions to a Reduced Carbon Future}%
      \hfill\makebox[0pt][r]{%
        \raisebox{\dimexpr-\height+\baselineskip}[0pt][0pt]
          {\includegraphics[height=3\baselineskip]{wpi_logo}}% Right logo
      }%
    }%
  }
  {I$^2$CNER-Enabled Transitions to a Reduced Carbon Future}} % Poster title
...
\author{
       ...
       % \textbf{I\textsuperscript{2}CNER Initiative on Challenges in Energy Assessment and Energy Transitions}\\
        Anshuman Chaube\inst{1}, Andrew Chapman\inst{2}, James Stubbins\inst{1}, Huan Yan \inst{1}, Kathryn Huff\inst{1}}
