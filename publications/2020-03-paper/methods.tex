...
\begin{table}[!ht]
	\caption{Electricity supply transition scenario definition.}
	\vspace{0.1in}
...
\begin{table}[!ht]
	...
	\vspace{0.1in}
	\begin{tabularx}{1.1\textwidth}{p{0.3\textwidth} p{0.25\textwidth} p{0.25\textwidth}p{0.3\textwidth}}
\hline 
